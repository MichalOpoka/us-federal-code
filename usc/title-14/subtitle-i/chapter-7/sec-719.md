...
(2) Other agreements not feasible.—A cooperative agreement containing a clause described in subsection (c)(1),<sup><a href="#719_2_target" name="719_2">2</a></sup> or under a transaction authorized by subsection (a), may be used for a research project only if the use of a standard contract, grant, or cooperative agreement for such project is not feasible or appropriate.
