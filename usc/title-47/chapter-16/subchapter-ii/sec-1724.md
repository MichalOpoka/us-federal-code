...
(B) determines that the grant is no longer necessary to achieve the original purpose for which Assistant <sup><a href="#1724_1_target" name="1724_1">1</a></sup> Secretary awarded the grant; and
...
[<sup>1</sup> So in original. Probably should be preceded by "the".](#1724_1)