...
For purposes of section 609(a)(14) of this title, a State operating a pilot must have a system for reducing the amount of assistance payable to a family if an individual refuses, without good cause (including for reasons described in 607(e)(2) <sup><a href="#611_2_target" name="611_2">2</a></sup> of this title), to engage in any such activities as the State has required of such an individual. A State without such a system shall be considered to have failed to comply with the requirements of section 607(e) of this title for so long as the failure to comply continues.
...
[<sup>2</sup> So in original. Probably should be preceded by "section".](#611_2)