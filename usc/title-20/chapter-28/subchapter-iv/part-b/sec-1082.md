...
For the purpose of carrying out this subsection, the records of any entity described in subparagraph (A), (B), (C), or (D) <sup><a href="#1082_1_target" name="1082_1">1</a></sup> of paragraph (1) shall be available to the Comptroller General and the Inspector General of the Department of Education. For the purpose of section 716(c) of title 31, such records shall be considered to be records to which the Comptroller General has access by law, and for the purpose of section 406(a)(4) of title 5, such records shall be considered to be records necessary in the performance of functions assigned by chapter 4 of title 5 to the Inspector General.
