...
(v) identifies as priority data assets any data asset for which disclosure would be in the public interest and establishes a plan to evaluate each priority data asset for disclosure on the Federal Data Catalogue under section 3511 and for a determination under <sup><a href="#3506_1_target" name="3506_1">1</a></sup> 3511(a)(2)(A)(iii)(I)(bb), including an accounting of which priority data assets have not yet been evaluated; and
...
[<sup>1</sup> So in original. Probably should be followed by "section".](#3506_1)