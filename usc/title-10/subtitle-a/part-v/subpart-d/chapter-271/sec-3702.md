...
(ii) The submission of prices paid under clause (i) by an offereor <sup><a href="#3702_1_target" name="3702_1">1</a></sup> with respect to a subcontract shall be deemed to be the submission of cost or pricing data by such offeror with respect to such subcontract as required by subparagraph (A) if a contracting officer of the Department of Defense determines that the prices submitted under such clause are fair and reasonable based on supported cost or pricing data within the last 12 months.
...
[<sup>1</sup> So in original. Probably should be "offeror".](#3702_1)