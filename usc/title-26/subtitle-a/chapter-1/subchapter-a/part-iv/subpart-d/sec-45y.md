...
#### (1) CO<sub>2</sub>e per KWh ####

The term "CO<sub>2</sub>e per KWh" means, with respect to any greenhouse gas, the equivalent carbon dioxide (as determined based on global warming potential) per kilowatt hour of electricity produced.
