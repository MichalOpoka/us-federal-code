...
To the greatest extent practicable, the report issued under subsection (f) <sup><a href="#2196_1_target" name="2196_1">1</a></sup> shall reflect the shared views of all eight Members, except that the report may contain dissenting views.
...
The Task Force shall terminate upon issuing the report required under subsection (f) <sup><a href="#2196_1_target" name="2196_1">1</a></sup>.

(Pub. L. 114–187, title IV, §409, June 30, 2016, 130 Stat. 593.)

[<sup>1</sup> So in original. Probably should be "subsection (g)".](#2196_1)