...
Subject to clause (ii) and with the consent of the non-Federal interest, the Secretary may use the authority provided under this subsection for a study in a work plan submitted to Congress prior to January 4, 2025, if the study otherwise meets the requirements described in subparagraph (A).
