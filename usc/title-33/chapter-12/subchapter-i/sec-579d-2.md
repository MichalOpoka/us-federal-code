...
The Secretary shall develop a preliminary list of each water resources development project, or separable element of a project, authorized for construction before June 10, 2014, for which—
...
**2025**—Subsecs. (a) to (c). Pub. L. 118–272 added subsec. (a) to (c) and struck out former subsecs. (a) to (c) which related to purposes of this section, proposed deauthorization list, and submission for congressional review and publication of final deauthorization list, respectively.
