...
As soon as practicable after October 17, 1986, the Administrator shall promulgate regulations describing criteria and parameters for the statement of need under subsection <sup><a href="#11043_1_target" name="11043_1">1</a></sup> (a) and (c) and the confidentiality agreement under subsection (d).
