...
The Administrator shall establish standards and requirements under this section for the model year 1996 and thereafter for vehicles weighing not more than 8,500 lbs. gvwr which are capable of operating on more than one fuel. Such standards shall require that such vehicles meet the exhaust standards applicable under subsection <sup><a href="#7583_2_target" name="7583_2">2</a></sup> (a), (b), and (c) for CO, NO<sub>x</sub>, and HCHO, and if appropriate, PM for single-fuel vehicles of the same vehicle category and model year.
