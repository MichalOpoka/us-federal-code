...
(B) the duties and activities of the Office described in subparagraphs (A) through (C) <sup><a href="#102_1_target" name="102_1">1</a></sup> of paragraph (1).
...
[<sup>1</sup> So in original. Paragraph (1) does not contain a subparagraph (C).](#102_1)