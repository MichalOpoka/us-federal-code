...
Any amount with respect to which a lien is imposed under paragraph (1) shall be treated as taxes due and owing the United States and rules similar to the rules of subsections (c), (d), and (e) of section 1368 of this title shall apply with respect to a lien imposed by subsection (a) <sup><a href="#1085a_1_target" name="1085a_1">1</a></sup> and the amount with respect to such lien.
...
[<sup>1</sup> So in original. Probably should be "paragraph (1)".](#1085a_1)