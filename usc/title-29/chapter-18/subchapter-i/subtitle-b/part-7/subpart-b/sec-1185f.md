...
(iii) the information described in subparagraph (B) with respect to each notification with respect to which such a determination was so made.<sup><a href="#1185f_1_target" name="1185f_1">1</a></sup>
...
[<sup>1</sup> So in original. The period probably should be a semicolon.](#1185f_1)